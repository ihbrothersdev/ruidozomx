    ...
    <div className={`font-akzidenz grid grid-rows-5 text-center ${className}`}>
      ...
      <div className='flex flex-col items-center justify-end px-1 lg:px-2'>
        {role === 'manager' && (
          ...
          >
            <p className='text-2xl leading-tight font-bold text-red-500 uppercase hover:underline sm:text-3xl md:text-2xl lg:text-4xl'>
              PROPÓN UNA
            </p>
          </button>
        )}
        ...
        >
          {role === 'venue' && (
            <>
              <p className='text-xl leading-tight text-black uppercase group-hover:underline sm:text-2xl md:text-xl lg:text-2xl'>
        ...
        {role === 'fan' && (
          <button
            ...
            className='pointer-events-auto row-span-2 flex cursor-pointer flex-col items-center justify-center px-1 lg:px-2'
          >
            <p className='text-2xl leading-tight font-bold text-red-500 uppercase hover:underline sm:text-3xl md:text-2xl lg:text-5xl xl:text-5xl'>
              PROPÓN UNA
            </p>
          </button>
        )}
        {role === 'banda' && (
          <button
            ...
            className='pointer-events-auto row-span-2 flex cursor-pointer flex-col items-center justify-center px-1 lg:px-2'
          >
            <p className='text-2xl leading-tight font-bold text-red-500 uppercase hover:underline sm:text-3xl md:text-2xl lg:text-3xl xl:text-3xl'>
              PROPÓN UNA DE TUS
            </p>
          </button>
        )}
      ...
      >
        {role === 'manager' && (
          <>
            ...
            <p className='text-base leading-tight text-red-500 uppercase group-hover:underline sm:text-lg md:text-sm lg:text-xl'>
              Del talento que mueves
            </p>
            <p className='text-base leading-tight text-black uppercase group-hover:underline sm:text-lg md:text-sm lg:text-xl'>
        ...
        {(role === 'promotor' || role === 'agente') && (
          <>
            <p className='text-xl leading-tight text-red-500 uppercase group-hover:underline sm:text-2xl md:text-lg lg:text-2xl'>
              PROPÓN UNA
            </p>
            <p className='text-5xl leading-none font-black text-red-500 uppercase group-hover:underline sm:text-6xl md:text-5xl lg:text-6xl'>
              ROLA
            </p>
            <p className='text-base leading-tight text-red-500 uppercase group-hover:underline sm:text-lg md:text-sm lg:text-xl'>
              Del talento que mueves
        ...
        {role === 'venue' && (
          <button className='group pointer-events-auto cursor-pointer'>
            <p className='text-xl leading-tight text-red-500 uppercase group-hover:underline sm:text-2xl md:text-xl lg:text-2xl'>
              PROPÓN UNA
            </p>
            <p className='text-5xl leading-none font-black text-red-500 uppercase group-hover:underline sm:text-6xl md:text-5xl lg:text-6xl'>
              ROLA
        ...
        {role === 'banda' && (
          <>
            <p className='text-6xl leading-none font-black text-red-500 uppercase group-hover:underline sm:text-7xl md:text-5xl lg:text-5xl xl:text-8xl'>
              ROLAS
            </p>
            <p className='mt-0.5 text-base leading-tight text-black uppercase group-hover:underline sm:text-lg md:text-sm lg:mt-1 lg:text-xl xl:text-xl'>
              PARA NUESTRO CASSETE SEMANAL
            </p>
          </>
        )}
        {role === 'proveedor' && (
          <>
            ...
            <p className='mt-0.5 text-base leading-tight text-red-500 uppercase group-hover:underline sm:text-lg md:text-sm lg:mt-1 lg:text-sm xl:text-lg'>
              De tu banda o artista favorito
            </p>
            <p className='mt-0.5 text-base leading-tight text-black uppercase group-hover:underline sm:text-lg md:text-sm lg:mt-1 lg:text-sm xl:text-lg'>
              para nuestro cassete semanal
            </p>
          </>
        )}
      ...
      <button
        ...
        className='group pointer-events-auto flex cursor-pointer flex-col items-center justify-center px-1 lg:px-2'
      >
        <p className='text-lg leading-tight text-black uppercase group-hover:underline sm:text-xl lg:text-2xl xl:text-3xl'>
          CORRE LA VOZ,
        </p>
        <p className='text-lg leading-tight text-black uppercase group-hover:underline sm:text-xl lg:text-xl xl:text-2xl'>
      ...
      <div className='pointer-events-auto flex items-center justify-center px-1 lg:px-2'>
        <Link
          href='/comunidad'
          className='text-2xl leading-tight text-black uppercase hover:underline sm:text-3xl md:text-3xl lg:text-3xl xl:text-3xl 2xl:text-4xl'
        >
          EXPLORAR LA ESCENA
        </Link>
      </div>
