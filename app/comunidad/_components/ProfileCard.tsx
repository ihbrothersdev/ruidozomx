...
export function ProfileCard({ profile }: ProfileCardProps) {
  ...
  return (
    ...
    >
      <div className='relative w-full overflow-hidden border-2 border-black/10 bg-[#e8e2d6] shadow-md'>
        ...
        <div className='flex flex-col items-center gap-0.5 px-3 pt-3 pb-2 text-center'>
