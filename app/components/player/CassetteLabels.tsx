    ...
    <>
      ...
      >
        <div className='absolute inset-0 flex flex-col items-center justify-center px-4'>
          <span className='font-corose-alt text-center text-3xl leading-tight text-gray-900 uppercase'>{songTitle}</span>
          <span className='font-corose text-center text-2xl leading-tight text-gray-700 uppercase'>{artist}</span>
        </div>
      </div>
