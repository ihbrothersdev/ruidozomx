    ...
    <>
      ...
      >
        <div className='absolute inset-0 flex flex-col items-center justify-center px-4'>
          <div className='relative w-full'>
            <TruncatedLabel
              text={songTitle}
              className='font-corose-alt block w-full truncate text-center text-md leading-tight font-bold text-black uppercase sm:text-2xl md:text-3xl'
            />
          </div>
      ...
      >
        <div className='absolute inset-0 flex items-center justify-center'>
          <span className='font-corose-alt text-[10px] leading-tight text-black whitespace-nowrap sm:text-base md:text-xl'>
            {date}
          </span>
        </div>
      </div>
